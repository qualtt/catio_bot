...
class Settings(BaseSettings):
    ...
    SCORE_AUTO_BONUS_PERCENT: int = 50
    ...
    PHOTO_TOURNAMENTS_ENABLED: bool = True
    PHOTO_TOURNAMENT_NOTIFY_HOUR: int = 12
    PHOTO_TOURNAMENT_NOTIFY_MINUTE: int = 0
    PHOTO_TOURNAMENT_ROUND_HOURS: int = 24
    PHOTO_TOURNAMENT_MIN_ENTRIES: int = 2
    PHOTO_TOURNAMENT_MONTHLY_WEEKS: int = 4
